...
set(CPACK_PACKAGE_VERSION "Online")

# Name the output file with the correct version
string(REPLACE "#CPACK_PACKAGE_VERSION#" "Online" CPACK_PACKAGE_FILE_NAME "${CPACK_PACKAGE_FILE_NAME}")
...
if (CPACK_BUNDLE_PLIST_SOURCE)
    ...
    string(REPLACE "#CPACK_PACKAGE_VERSION#" "Online" INFO_PLIST_CONTENT "${INFO_PLIST_CONTENT}")
